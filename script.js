    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Pilates by Lilosh uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '2ac9a632-c1a3-4df2-ab75-6fb3dcd581dc',
                    name: data.name || '',
                    email: data.email || '',
